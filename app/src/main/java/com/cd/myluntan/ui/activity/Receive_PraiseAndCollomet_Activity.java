...
public class Receive_PraiseAndCollomet_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receive__praise_and_collomet);
